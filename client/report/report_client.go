...
// New creates a new report API client with basic auth credentials.
...
// New creates a new report API client with a bearer token for authentication.
// It takes the following parameters:
// - host: http host (github.com).
// - basePath: any base path for the API client ("/v1", "/v3").
// - scheme: http scheme ("http", "https").
...
func (a *Client) ReportReportDetailGet(params *ReportReportDetailGetParams, opts ...ClientOption) (*ReportReportDetailGetOK, error) {
	...
	if params == nil {
		params = NewReportReportDetailGetParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "Report_ReportDetailGet",
		Method:             "GET",
		PathPattern:        "/v1/reports/{reportID}",
		ProducesMediaTypes: []string{"application/json", "text/json", "application/xml", "text/xml"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &ReportReportDetailGetReader{formats: a.formats},
	...
	success, ok := result.(*ReportReportDetailGetOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for Report_ReportDetailGet: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) ReportReportListGet(params *ReportReportListGetParams, opts ...ClientOption) (*ReportReportListGetOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewReportReportListGetParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "Report_ReportListGet",
		Method:             "GET",
		...
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &ReportReportListGetReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	for _, opt := range opts {
	...
	success, ok := result.(*ReportReportListGetOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for Report_ReportListGet: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
