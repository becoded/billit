...
// NewToProcessPostToProcessParams creates a new ToProcessPostToProcessParams object,
...
func NewToProcessPostToProcessParams() *ToProcessPostToProcessParams {
	return &ToProcessPostToProcessParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewToProcessPostToProcessParamsWithTimeout creates a new ToProcessPostToProcessParams object
...
// NewToProcessPostToProcessParamsWithContext creates a new ToProcessPostToProcessParams object
...
// NewToProcessPostToProcessParamsWithHTTPClient creates a new ToProcessPostToProcessParams object
...
func (o *ToProcessPostToProcessParams) WithDefaults() *ToProcessPostToProcessParams {
	o.SetDefaults()
	return o
}
...
func (o *ToProcessPostToProcessParams) WithTimeout(timeout time.Duration) *ToProcessPostToProcessParams {
...
func (o *ToProcessPostToProcessParams) WithContext(ctx context.Context) *ToProcessPostToProcessParams {
	o.SetContext(ctx)
	return o
}
...
func (o *ToProcessPostToProcessParams) WithHTTPClient(client *http.Client) *ToProcessPostToProcessParams {
...
func (o *ToProcessPostToProcessParams) WithToProcess(toProcess *model.ToProcessSaveRequest) *ToProcessPostToProcessParams {
	o.SetToProcess(toProcess)
	return o
}
...
func (o *ToProcessPostToProcessParams) SetToProcess(toProcess *model.ToProcessSaveRequest) {
	o.ToProcess = toProcess
}

// WriteToRequest writes these params to a swagger request
func (o *ToProcessPostToProcessParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	var res []error
	if o.ToProcess != nil {
		if err := r.SetBodyParam(o.ToProcess); err != nil {
			return err
		}
	}
