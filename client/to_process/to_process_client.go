...
// New creates a new to process API client with basic auth credentials.
...
// New creates a new to process API client with a bearer token for authentication.
// It takes the following parameters:
// - host: http host (github.com).
// - basePath: any base path for the API client ("/v1", "/v3").
// - scheme: http scheme ("http", "https").
...
func (a *Client) ToProcessDeleteToProcess(params *ToProcessDeleteToProcessParams, opts ...ClientOption) (*ToProcessDeleteToProcessOK, error) {
	...
	if params == nil {
		params = NewToProcessDeleteToProcessParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "ToProcess_DeleteToProcess",
		Method:             "DELETE",
		PathPattern:        "/v1/toProcess/{uploadID}",
		ProducesMediaTypes: []string{"application/json", "text/json", "application/xml", "text/xml"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &ToProcessDeleteToProcessReader{formats: a.formats},
	...
	success, ok := result.(*ToProcessDeleteToProcessOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for ToProcess_DeleteToProcess: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) ToProcessPostToProcess(params *ToProcessPostToProcessParams, opts ...ClientOption) (*ToProcessPostToProcessOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewToProcessPostToProcessParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "ToProcess_PostToProcess",
		Method:             "POST",
		PathPattern:        "/v1/toProcess",
		ProducesMediaTypes: []string{"application/json", "text/json", "application/xml", "text/xml"},
		ConsumesMediaTypes: []string{"application/json", "text/json", "application/xml", "text/xml", "application/x-www-form-urlencoded"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &ToProcessPostToProcessReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	for _, opt := range opts {
	...
	success, ok := result.(*ToProcessPostToProcessOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for ToProcess_PostToProcess: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
