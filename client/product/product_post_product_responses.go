...
func (o *ProductPostProductReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewProductPostProductOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /v1/products] Product_PostProduct", response, response.Code())
	}
}
...
func (o *ProductPostProductOK) Error() string {
	...
	return fmt.Sprintf("[POST /v1/products][%d] productPostProductOK %s", 200, payload)
}
...
func (o *ProductPostProductOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
