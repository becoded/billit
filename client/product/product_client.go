...
func (a *Client) ProductGetProduct(params *ProductGetProductParams, opts ...ClientOption) (*ProductGetProductOK, error) {
	...
	success, ok := result.(*ProductGetProductOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for Product_GetProduct: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) ProductGetProducts(params *ProductGetProductsParams, opts ...ClientOption) (*ProductGetProductsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewProductGetProductsParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "Product_GetProducts",
		Method:             "GET",
		...
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &ProductGetProductsReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	for _, opt := range opts {
	...
	success, ok := result.(*ProductGetProductsOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for Product_GetProducts: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) ProductPostProduct(params *ProductPostProductParams, opts ...ClientOption) (*ProductPostProductOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewProductPostProductParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "Product_PostProduct",
		Method:             "POST",
		PathPattern:        "/v1/products",
		ProducesMediaTypes: []string{"application/json", "text/json", "application/xml", "text/xml"},
		...
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &ProductPostProductReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	for _, opt := range opts {
	...
	success, ok := result.(*ProductPostProductOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for Product_PostProduct: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
