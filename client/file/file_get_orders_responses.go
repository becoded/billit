...
func (o *FileGetOrdersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewFileGetOrdersOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/files/{fileID}] File_GetOrders", response, response.Code())
	}
}

// NewFileGetOrdersOK creates a FileGetOrdersOK with default headers values
func NewFileGetOrdersOK() *FileGetOrdersOK {
	return &FileGetOrdersOK{}
}
...
func (o *FileGetOrdersOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/files/{fileID}][%d] fileGetOrdersOK %s", 200, payload)
}
...
func (o *FileGetOrdersOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(model.File)
