...
// New creates a new misc API client with basic auth credentials.
...
// New creates a new misc API client with a bearer token for authentication.
// It takes the following parameters:
// - host: http host (github.com).
// - basePath: any base path for the API client ("/v1", "/v3").
// - scheme: http scheme ("http", "https").
...
func (a *Client) MiscGetCompanySearch(params *MiscGetCompanySearchParams, opts ...ClientOption) (*MiscGetCompanySearchOK, error) {
	...
	if params == nil {
		params = NewMiscGetCompanySearchParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "Misc_GetCompanySearch",
		Method:             "GET",
		PathPattern:        "/v1/misc/companysearch/{Keywords}",
		ProducesMediaTypes: []string{"application/json", "text/json", "application/xml", "text/xml"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &MiscGetCompanySearchReader{formats: a.formats},
	...
	success, ok := result.(*MiscGetCompanySearchOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for Misc_GetCompanySearch: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) MiscGetTranslation(params *MiscGetTranslationParams, opts ...ClientOption) (*MiscGetTranslationOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewMiscGetTranslationParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "Misc_GetTranslation",
		Method:             "GET",
		PathPattern:        "/v1/misc/typecodes/{TypeCodeType}/{key}/{language}",
		ProducesMediaTypes: []string{"application/json", "text/json", "application/xml", "text/xml"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &MiscGetTranslationReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	for _, opt := range opts {
	...
	success, ok := result.(*MiscGetTranslationOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for Misc_GetTranslation: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) MiscGetTypeCodes(params *MiscGetTypeCodesParams, opts ...ClientOption) (*MiscGetTypeCodesOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewMiscGetTypeCodesParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "Misc_GetTypeCodes",
		Method:             "GET",
		PathPattern:        "/v1/misc/typecodes/{TypeCodeType}",
		ProducesMediaTypes: []string{"application/json", "text/json", "application/xml", "text/xml"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &MiscGetTypeCodesReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	for _, opt := range opts {
	...
	success, ok := result.(*MiscGetTypeCodesOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for Misc_GetTypeCodes: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
