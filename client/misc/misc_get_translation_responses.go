...
func (o *MiscGetTranslationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewMiscGetTranslationOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/misc/typecodes/{TypeCodeType}/{key}/{language}] Misc_GetTranslation", response, response.Code())
	}
}
...
func (o *MiscGetTranslationOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/misc/typecodes/{TypeCodeType}/{key}/{language}][%d] miscGetTranslationOK %s", 200, payload)
}
...
func (o *MiscGetTranslationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
