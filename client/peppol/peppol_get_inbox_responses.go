...
func (o *PeppolGetInboxReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPeppolGetInboxOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/peppol/inbox] Peppol_GetInbox", response, response.Code())
	}
}

// NewPeppolGetInboxOK creates a PeppolGetInboxOK with default headers values
func NewPeppolGetInboxOK() *PeppolGetInboxOK {
	return &PeppolGetInboxOK{}
}
...
func (o *PeppolGetInboxOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/peppol/inbox][%d] peppolGetInboxOK %s", 200, payload)
}
...
func (o *PeppolGetInboxOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(model.InboxGetResult)
