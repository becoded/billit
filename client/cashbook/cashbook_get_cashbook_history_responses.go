...
func (o *CashbookGetCashbookHistoryReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewCashbookGetCashbookHistoryOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/Cashbook/{cashbookID}/History] Cashbook_GetCashbookHistory", response, response.Code())
	}
}
...
func NewCashbookGetCashbookHistoryOK() *CashbookGetCashbookHistoryOK {
	return &CashbookGetCashbookHistoryOK{}
}
...
func (o *CashbookGetCashbookHistoryOK) Code() int {
	return 200
}

func (o *CashbookGetCashbookHistoryOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/Cashbook/{cashbookID}/History][%d] cashbookGetCashbookHistoryOK %s", 200, payload)
}

func (o *CashbookGetCashbookHistoryOK) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/Cashbook/{cashbookID}/History][%d] cashbookGetCashbookHistoryOK %s", 200, payload)
}

func (o *CashbookGetCashbookHistoryOK) GetPayload() *model.PageResultCashbookEntry {
	return o.Payload
}

func (o *CashbookGetCashbookHistoryOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
