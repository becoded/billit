...
func (o *CashbookPostCashbookEntryReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewCashbookPostCashbookEntryOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /v1/Cashbook/AddEntry] Cashbook_PostCashbookEntry", response, response.Code())
	}
}
...
func NewCashbookPostCashbookEntryOK() *CashbookPostCashbookEntryOK {
	return &CashbookPostCashbookEntryOK{}
}
...
func (o *CashbookPostCashbookEntryOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /v1/Cashbook/AddEntry][%d] cashbookPostCashbookEntryOK %s", 200, payload)
}
...
func (o *CashbookPostCashbookEntryOK) GetPayload() *model.CashbookEntry {
	return o.Payload
}

func (o *CashbookPostCashbookEntryOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(model.CashbookEntry)
