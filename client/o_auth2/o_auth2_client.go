...
// New creates a new o auth2 API client with basic auth credentials.
...
// New creates a new o auth2 API client with a bearer token for authentication.
// It takes the following parameters:
// - host: http host (github.com).
// - basePath: any base path for the API client ("/v1", "/v3").
// - scheme: http scheme ("http", "https").
...
func (a *Client) OAuth2PostToken(params *OAuth2PostTokenParams, opts ...ClientOption) (*OAuth2PostTokenOK, error) {
	...
	if params == nil {
		params = NewOAuth2PostTokenParams()
	}
	op := &runtime.ClientOperation{
		...
		Params:             params,
		Reader:             &OAuth2PostTokenReader{formats: a.formats},
	...
	success, ok := result.(*OAuth2PostTokenOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for OAuth2_PostToken: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) OAuth2PostTokenRevoke(params *OAuth2PostTokenRevokeParams, opts ...ClientOption) (*OAuth2PostTokenRevokeOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewOAuth2PostTokenRevokeParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "OAuth2_PostTokenRevoke",
		Method:             "POST",
		...
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &OAuth2PostTokenRevokeReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	for _, opt := range opts {
	...
	success, ok := result.(*OAuth2PostTokenRevokeOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for OAuth2_PostTokenRevoke: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
