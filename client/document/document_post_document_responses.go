...
func (o *DocumentPostDocumentReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDocumentPostDocumentOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /v1/documents] Document_PostDocument", response, response.Code())
	}
}
...
func (o *DocumentPostDocumentOK) Error() string {
	...
	return fmt.Sprintf("[POST /v1/documents][%d] documentPostDocumentOK %s", 200, payload)
}
...
func (o *DocumentPostDocumentOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
