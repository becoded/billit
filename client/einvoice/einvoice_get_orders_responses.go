...
func (o *EinvoiceGetOrdersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewEinvoiceGetOrdersOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/einvoices/registrations/{registrationID}/orders] Einvoice_GetOrders", response, response.Code())
	}
}
...
func (o *EinvoiceGetOrdersOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/einvoices/registrations/{registrationID}/orders][%d] einvoiceGetOrdersOK %s", 200, payload)
}
...
func (o *EinvoiceGetOrdersOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
