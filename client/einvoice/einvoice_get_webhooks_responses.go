...
func (o *EinvoiceGetWebhooksReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewEinvoiceGetWebhooksOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/einvoices/registrations/{registrationID}/webhooks] Einvoice_GetWebhooks", response, response.Code())
	}
}
...
func (o *EinvoiceGetWebhooksOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/einvoices/registrations/{registrationID}/webhooks][%d] einvoiceGetWebhooksOK %s", 200, payload)
}
...
func (o *EinvoiceGetWebhooksOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
