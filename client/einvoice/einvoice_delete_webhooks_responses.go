...
func (o *EinvoiceDeleteWebhooksReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewEinvoiceDeleteWebhooksOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /v1/einvoices/registrations/{registrationID}/webhooks/{webhookID}] Einvoice_DeleteWebhooks", response, response.Code())
	}
}
...
func NewEinvoiceDeleteWebhooksOK() *EinvoiceDeleteWebhooksOK {
	return &EinvoiceDeleteWebhooksOK{}
}
...
func (o *EinvoiceDeleteWebhooksOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /v1/einvoices/registrations/{registrationID}/webhooks/{webhookID}][%d] einvoiceDeleteWebhooksOK %s", 200, payload)
}
...
func (o *EinvoiceDeleteWebhooksOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
