...
func (o *AccountGetSSOTokenReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewAccountGetSSOTokenOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/account/ssoToken] Account_GetSSOToken", response, response.Code())
	}
}
...
func (o *AccountGetSSOTokenOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/account/ssoToken][%d] accountGetSSOTokenOK %s", 200, payload)
}
...
func (o *AccountGetSSOTokenOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
