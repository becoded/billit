...
// NewAccountPostSequencesParams creates a new AccountPostSequencesParams object,
...
func NewAccountPostSequencesParams() *AccountPostSequencesParams {
	return &AccountPostSequencesParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewAccountPostSequencesParamsWithTimeout creates a new AccountPostSequencesParams object
...
// NewAccountPostSequencesParamsWithContext creates a new AccountPostSequencesParams object
...
// NewAccountPostSequencesParamsWithHTTPClient creates a new AccountPostSequencesParams object
...
func (o *AccountPostSequencesParams) WithSequenceRequest(sequenceRequest *model.SequenceRequest) *AccountPostSequencesParams {
	o.SetSequenceRequest(sequenceRequest)
	return o
}
...
func (o *AccountPostSequencesParams) SetSequenceRequest(sequenceRequest *model.SequenceRequest) {
	o.SequenceRequest = sequenceRequest
}
...
func (o *AccountPostSequencesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	var res []error
	if o.SequenceRequest != nil {
		if err := r.SetBodyParam(o.SequenceRequest); err != nil {
			return err
		}
	}
