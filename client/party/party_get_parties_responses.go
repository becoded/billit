...
func (o *PartyGetPartiesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPartyGetPartiesOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/parties] Party_GetParties", response, response.Code())
	}
}

// NewPartyGetPartiesOK creates a PartyGetPartiesOK with default headers values
func NewPartyGetPartiesOK() *PartyGetPartiesOK {
	return &PartyGetPartiesOK{}
}
...
func (o *PartyGetPartiesOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/parties][%d] partyGetPartiesOK %s", 200, payload)
}
...
func (o *PartyGetPartiesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
