...
func (m *PageResultParty) validateItems(formats strfmt.Registry) error {
...
func (m *PageResultParty) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
