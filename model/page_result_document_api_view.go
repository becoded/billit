...
func (m *PageResultDocumentAPIView) validateItems(formats strfmt.Registry) error {
...
func (m *PageResultDocumentAPIView) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageResultDocumentAPIView) UnmarshalBinary(b []byte) error {
	var res PageResultDocumentAPIView
