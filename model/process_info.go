...
func (m *ProcessInfo) validateEndpoints(formats strfmt.Registry) error {
...
func (m *ProcessInfo) contextValidateEndpoints(ctx context.Context, formats strfmt.Registry) error {
