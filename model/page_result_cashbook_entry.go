...
func (m *PageResultCashbookEntry) validateItems(formats strfmt.Registry) error {
...
func (m *PageResultCashbookEntry) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageResultCashbookEntry) UnmarshalBinary(b []byte) error {
	var res PageResultCashbookEntry
